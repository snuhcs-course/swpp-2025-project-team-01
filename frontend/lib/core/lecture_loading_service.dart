...
class LectureLoadingService extends ChangeNotifier {
  ...
  List<String> get _friendlyMessages => _l10n.loadingFriendlyMessages;
  ...
  void completeLoading({String? lectureId}) {
    ...
    _messageTimer?.cancel();
    _progress = 1.0;
    _message = _l10n.lectureCreationCompleted;
  ...
  void setError({String? errorTitle, String? errorMessage}) {
    ...
    // 에러 메시지 설정
    _errorMessage = errorMessage ?? _l10n.networkErrorMessage;
  ...
  void cancelLoading() {
    _messageTimer?.cancel();
    _isCancelled = true;
    _message = _l10n.cancellingLecture;
    notifyListeners();
